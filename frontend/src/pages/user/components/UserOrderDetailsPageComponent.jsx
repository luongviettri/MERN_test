...
export default function UserOrderDetailsPageComponent({
  ...
  //! hàm dùng để xử lí sau đặt hàng
  const updateStateAfterOrder = (paidAt) => {
    setOrderButtonMessage('Thank you for your payment!');
    setIsPaid(paidAt); //2 paidAt là ngày đơn hàng này được thanh toán
    setButtonDisabled(true);
          ...
          <ListGroup>
            ...
            <ListGroup.Item>
              ...
              <div style={{ position: 'relative', zIndex: 1 }}>
                {/* //! lấy id để thư viện paypal xài chứ mình tham chiếu DOM qua useRef */}
